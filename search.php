...
if (isset($_POST['name-product'])) {
    ...
    if (mysqli_num_rows($result)) {
        while ($table = mysqli_fetch_array($result)) {
            $render .= '
                ...
                <div class="product-item">
                    <div class="pi-pic">
                        ...
                        <ul>
                            <li class="w-icon active"><a href="detail.php?id=' . $table['id'] . '"><i class="icon_bag_alt"></i></a></li>
            ...
            if ($table['category_id'] == 1) $render .= "Thời trang Nam";
            else if ($table['category_id'] == 2) $render .= "Thời trang Nữ";
            else $render .= "Hàng mới về";
            $render .= '</div>
                        <a href="#">
                            <h5>' . $table['name'] . '</h5>
                        </a>
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="advanced-search">
                            ...
                            <form action="#" class="input-group">
                                <input type="text" placeholder="What do you need?" name="name-product">
